...
الـ SDN هي طريقة حديثة في الشبكات بتفصل بين جزء التحكم (اللي بيحدد وين تروح البيانات) وجزء تمرير البيانات (اللي بينفذ التوجيه فعليًا). زمان الأجهزة زي الروترات والسويتشات كانت بتعمل الاتنين، بس في SDN التحكم بيكون مركزي في برنامج خاص، وباقي الأجهزة بتنفيذ أوامره بس. الطريقة دي بتخلي إدارة الشبكة أسهل وأكتر مرونة.
