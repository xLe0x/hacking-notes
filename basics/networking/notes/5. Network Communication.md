...
,بيشتغل على الطبقة التالتة (Network Layer) من نموذج OSI.  

في نوعين:
- **IPv4**: بيكون 32 بت وبيظهر بالشكل ده مثلًا: `192.168.1.1`
- **IPv6**: بيكون 128 بت، معمول علشان نعوّض نقص عناوين IPv4، وبيظهر بالشكل ده: `2001:0db8:85a3:0000:0000:8a2e:0370:7334`
...
- بيتغلف بـ TCP ويتحدد البورت (80 أو 443)  
